...
GETH_ARGS="--datadir /qdata/dd --raft --rpc --rpcaddr 0.0.0.0  --nodiscover --unlock 0 --password /qdata/passwords.txt"
...
PRIVATE_CONFIG=$TMCONF nohup /usr/local/bin/geth $GETH_ARGS --rpccorsdomain "*" 2>>/qdata/logs/geth.log
